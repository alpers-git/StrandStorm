...
namespace ssCore
{
    ...
    void OpenGLProgram::SetUniform(const char *name, glm::vec2 value)
    {
        GLint location;
        GL_CALL(location = glGetUniformLocation(glID, name));
        if (location == -1)
    ...
    void OpenGLProgram::SetUniform(const char *name, glm::vec3 value)
    {
        GLint location;
        GL_CALL(location = glGetUniformLocation(glID, name));
        if (location == -1)
    ...
    void OpenGLProgram::SetUniform(const char *name, glm::vec4 value)
    {
        GLint location;
        GL_CALL(location = glGetUniformLocation(glID, name));
        if (location == -1)
    ...
    void OpenGLProgram::SetUniform(const char* name, glm::mat2 value)
	{
		GLint location;
		GL_CALL(location = glGetUniformLocation(glID, name));
		if (location == -1)
    ...
    void OpenGLProgram::SetUniform(const char* name, glm::mat3 value)
    {
        GLint location;
        GL_CALL(location = glGetUniformLocation(glID, name));
        if (location == -1)
    ...
    void OpenGLProgram::SetUniform(const char* name, glm::mat4 value)
    {
        GLint location;
        GL_CALL(location = glGetUniformLocation(glID, name));
        if (location == -1)
